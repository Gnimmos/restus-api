...
function cangedate(date) {
  ...
  fs.readFile(path.join(__dirname, '../sql/compares.sql'), 'utf8', function (err,data) {
  if (err) {
    ...
    console.log("Success2: "+ result)
      ...
      fs.writeFile(path.join(__dirname, '../sql/compares.sql'), result, 'utf8', function (err) {
